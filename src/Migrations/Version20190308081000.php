 ...
 */
final class Version20190308081000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products ADD thumbnail VARCHAR(50) NOT NULL, CHANGE created created DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE modified modified DATETIME DEFAULT NULL, CHANGE deleted deleted DATETIME DEFAULT NULL');
