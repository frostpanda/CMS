...
//    public function getIniMaxFilesPerRequest(){
//        return trim(ini_get('max_file_uploads'));
//    }
//    
//    public function hasPostMaxFilesBeenExceed(string $formName){
//        $filesArray = $this->requestStack->getCurrentRequest()->files->get($formName);
//        echo '<pre>';
//        var_dump(count($filesArray[key($filesArray)])); die;
////        return count($this->requestStack->files->get)
//    }
}
